import { ChartOptions } from "./candlestick.model";
 ...
 */
const basicCandlestickChart: ChartOptions = {
  series: [{
    data: [{
 ...
 */
const chartCandleOptions: ChartOptions = {
  series: [{
    data: seriesData
  }],
  chart: {
 ...
 * Category X-Axis
 */
const categoryXAxisChart: ChartOptions = {
  series: [
    {
      name: "candle",
      data: [
...
export { basicCandlestickChart, chartCandleOptions, chartBarOptions, categoryXAxisChart }