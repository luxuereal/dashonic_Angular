import { ChartOptions } from "./scatter.model";
 ...
 * Basic Scatter Chart
 */
const basicScatterChart: ChartOptions = {
    series: [{
        name: "SAMPLE A",
        data: [
 ...
 */
const dateTimeScatterChart: ChartOptions = {
    series: [{
        name: 'TEAM 1',
 ...
 */
const ScatterImagesChart: ChartOptions = {
    series: [
        {
            name: "Image2",
            data: [
